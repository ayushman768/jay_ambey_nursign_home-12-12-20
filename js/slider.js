   var myBnner_section = (function() {
       ...
       var arr = [{
           ...
           moarq_text: "Treatment facility by <b>'Ayushman Card'</b> <u>Jai Ambey Nursing Home and Netralaya,</u> <i>Address : </i><b> Maharana Pratap Chowk,Near Ring Road 2 Chandel Nagar Bilaspur Chhattisgarh(495001).</b>"
       }];
       ...
       document.querySelector('section').innerHTML += `
                ...
                <img src="${arr[0].banner01}" alt="Chicago">
                </div>
				<div class="item ">
				...
				<div class="item ">
                <img src="${arr[0].banner05}" alt="Los Angeles">
                </div>
                <div class="item">
